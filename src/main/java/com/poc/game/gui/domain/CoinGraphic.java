package com.poc.game.gui.domain;
...
public class CoinGraphic extends Prop implements IUpdateable, IRenderable {
    ...
    public CoinGraphic(String name, double x, double y, int value,PointsContext context, HUDController controller) {
        super(x, y, name);
    ...
    public void update() {
        if (Input.keyboard().isPressed(java.awt.event.KeyEvent.VK_X) && isPlayerNearby() && isRendered) {
            ...
            this.context.addPoints(this.value);
